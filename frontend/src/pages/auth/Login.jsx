...
export const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-sports-dark px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="sports-card">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Sign in to continue to TurfAuction Pro</p>
          </div>
